...
class CreateChallengeTest < ActionDispatch::IntegrationTest
  test 'it successfully creates a normal challenge' do
    ...
    post post_end_point, params: body.to_json, headers: authenticated_header(challenger)
  ...
  test 'it returns a 403 when trying to challenge an alternate spot' do
    performance = create(:performance)
    challenger = create(:alternate_user, :trumpet, :solo, :spot_a13)
    create(:user, :trumpet, :solo, :spot_a2)
    body = {
  ...
  test 'it returns a 403 when trying to challenge a non open spot twice' do
    ...
    post post_end_point, params: body.to_json, headers: authenticated_header(challenger)
    post post_end_point, params: body.to_json, headers: authenticated_header(other_challenger)
  ...
  test 'it returns a 403 when a user tries to make a second challenge' do
    ...
    post post_end_point, params: body.to_json, headers: authenticated_header(challenger)
    post post_end_point, params: other_body.to_json, headers: authenticated_header(challenger)
  ...
  test 'it adds user to challenge if a user tries to create a challenged, but not full open spot' do
    ...
    create(:discipline, user: challengee, open_spot: true, performance: performance)
    post post_end_point, params: body.to_json, headers: authenticated_header(challenger)
    post post_end_point, params: other_body.to_json, headers: authenticated_header(other_challenger)
