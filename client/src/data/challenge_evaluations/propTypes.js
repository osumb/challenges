...
const challengeForEvaluationPropTypes = {
  ...
  userChallenges: PropTypes.arrayOf(PropTypes.shape(userChallengeForEvaluationPropTypes)),
  users: PropTypes.arrayOf(PropTypes.shape(userProps)),
};

const challengesForEvaluationPropTypes = {
  challenges: PropTypes.arrayOf(PropTypes.shape(challengeForEvaluationPropTypes)).isRequired,
};
