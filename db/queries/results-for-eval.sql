SELECT t1.name AS first_name, t2.name AS second_name, t1.spot_id AS spot_id, t1.id AS result_id, t1.name_number AS first_name_number,
...
FROM
  (
    ...
    WHERE r1.first_name_number = u1.name_number AND NOT r1.needs_approval AND r1.pending
  ) t1
LEFT JOIN
  (
