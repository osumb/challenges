...
ActiveRecord::Schema.define(version: 20171114012621) do
  ...
  create_table "challenges", force: :cascade do |t|
    ...
    t.index ["performance_id", "spot_id"], name: "index_challenges_on_performance_and_spot", unique: true, using: :btree
  ...
  create_table "performances", force: :cascade do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.boolean  "list_exported", default: false
  end
  ...
  create_table "spots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["row", "file"], name: "index_spots_on_row_and_file", unique: true, using: :btree
  end
