...
CREATE TRIGGER spots_modified_stamp BEFORE INSERT OR UPDATE ON spots
...
CREATE TRIGGER users_modified_stamp BEFORE INSERT OR UPDATE ON users
FOR EACH ROW EXECUTE PROCEDURE modified_stamp();
...
CREATE TRIGGER performances_modified_stamp BEFORE INSERT OR UPDATE ON performances
FOR EACH ROW EXECUTE PROCEDURE modified_stamp();
...
CREATE TRIGGER challenges_modified_stamp BEFORE INSERT OR UPDATE ON challenges
FOR EACH ROW EXECUTE PROCEDURE modified_stamp();
...
CREATE TRIGGER results_modified_stamp BEFORE INSERT OR UPDATE ON results
FOR EACH ROW EXECUTE PROCEDURE modified_stamp();
...
CREATE TRIGGER manage_modified_stamp BEFORE INSERT OR UPDATE ON manage
FOR EACH ROW EXECUTE PROCEDURE modified_stamp();
